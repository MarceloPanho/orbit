...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.marcelopanho.orbit'),
     ...
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'Marcelo Panho'),

    /**
     * The copyright notice for your application.
     */
    'copyright' => env('NATIVEPHP_APP_COPYRIGHT', '© Marcelo Panho'),

    /**
     * The description of your application.
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Sistema operacional pessoal — finanças, agenda, notas e hábitos'),

    /**
     * The Website of your application.
     */
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://github.com/MarceloPanho/orbit'),
    ...
    'updater' => [
        ...
        'providers' => [
            'github' => [
                ...
                'owner' => env('GITHUB_OWNER', 'MarceloPanho'),
